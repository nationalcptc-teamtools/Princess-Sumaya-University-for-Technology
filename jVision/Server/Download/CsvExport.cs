...
namespace jVision.Server.Download
{
	public class CsvExport
	{
		...
		/// </param>
		public CsvExport(string columnSeparator = ",", bool includeColumnSeparatorDefinitionPreamble = false, bool includeHeaderRow = true)
		{
		...
		public void AddContent(List<string> s)
        {
			_content = s;
        }
